...
const HistorialCompras = () => {
    ...
    return (
        <div className="background-div"> {/* Fondo oscuro con opacidad */}
            <NavbarUser />
            <div className="historial-container">
                <center><h2 className="title-box">Historial de Compras</h2></center>
                {compras.length === 0 ? (
                    <p>No hay compras registradas.</p>
                ) : (
                    <div className="compras-list">
                        {compras.map(compra => (
                            <div key={compra.id} className="compra-card-new"> {/* Tarjetas con nuevo estilo */}
