...
const PerfilUsuario = () => {
    ...
    const handleChange = (e) => {
        ...
        // Update location if postal code changes
        if (name === 'postalCode') {
            const locationInfo = cpData[value];
            if (locationInfo) {
                setAvailableDistricts(locationInfo);
                setUserData(prev => ({
                    ...prev,
                ...
                setAvailableDistricts([]); // Clear districts
            }
        }

        // Update district if a new one is selected
        if (name === 'district') {
    ...
    return (
        <div className="background-div">
            <NavbarSeller />
            <center><h1 className="title-box">Perfil de Usuario</h1></center>
            {message && <p>{message}</p>}
                        ...
                        <div className="form-group">
                            <label>
                                ...
                                <select
                                    ...
                                    disabled={!isEditing}
                                >
                                    {availableDistricts.map((loc, index) => (
